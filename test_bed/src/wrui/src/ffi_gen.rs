...
pub struct PUPluginUI {
    ...
    pub create_url: extern "C" fn(priv_data: *const PUBase) -> PUUrl,
    pub create_mime_data: extern "C" fn(priv_data: *const PUBase) -> PUMimeData,
    ...
    pub create_paint_event: extern "C" fn(priv_data: *const PUBase) -> PUPaintEvent,
    pub create_drag_enter_event: extern "C" fn(priv_data: *const PUBase) -> PUDragEnterEvent,
    pub create_drop_event: extern "C" fn(priv_data: *const PUBase) -> PUDropEvent,
    pub create_layout: extern "C" fn(priv_data: *const PUBase) -> PULayout,
