...
typedef void (*Signal_self_Action_void)(void* self_c, void* wrapped_func, struct RUBase* action);
...
public:
    ...
    Q_SLOT void method(QAction* action) {
        auto temp_arg_1 = RUAction { (struct RUBase*)action, &s_action_funcs  };
...
typedef void (*Signal_self_ListWidgetItem_void)(void* self_c, void* wrapped_func, struct RUBase* item);
...
public:
    ...
    Q_SLOT void method(QListWidgetItem* item) {
        auto temp_arg_1 = RUListWidgetItem { (struct RUBase*)item, &s_list_widget_item_funcs  };
        m_func(m_data, m_wrapped_func, (struct RUBase*)&temp_arg_1);
    }
private:
