...
typedef struct RULineEditFuncs {
    ...
    uint32_t (*echo_mode)(struct RUBase* self_c);
    void (*set_echo_mode)(struct RUBase* self_c, uint32_t arg0);
    ...
    void (*set_alignment)(struct RUBase* self_c, uint32_t flag);
    ...
    void (*set_cursor_move_style)(struct RUBase* self_c, uint32_t style);
    uint32_t (*cursor_move_style)(struct RUBase* self_c);
