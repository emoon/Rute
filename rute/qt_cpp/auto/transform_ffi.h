...
typedef struct RUTransformFuncs {
    ...
    struct RUTransform (*inverted)(struct RUBase* self_c, struct RUBase* invertible);
    ...
    struct RUTransform (*rotate_radians)(struct RUBase* self_c, float a, int axis);
    bool (*square_to_quad)(struct RUBase* self_c, struct RUBase* square, struct RUBase* result);
    bool (*quad_to_square)(struct RUBase* self_c, struct RUBase* quad, struct RUBase* result);
    bool (*quad_to_quad)(struct RUBase* self_c, struct RUBase* one, struct RUBase* two, struct RUBase* result);
    void (*reset)(struct RUBase* self_c);
    struct RUPoint (*map)(struct RUBase* self_c, struct RUBase* p);
    struct RUPointF (*map)(struct RUBase* self_c, struct RUBase* p);
    struct RULine (*map)(struct RUBase* self_c, struct RUBase* l);
    struct RULineF (*map)(struct RUBase* self_c, struct RUBase* l);
    struct RUPolygonF (*map)(struct RUBase* self_c, struct RUBase* a);
    struct RUPolygon (*map)(struct RUBase* self_c, struct RUBase* a);
    struct RURegion (*map)(struct RUBase* self_c, struct RUBase* r);
    struct RUPainterPath (*map)(struct RUBase* self_c, struct RUBase* p);
    ...
    struct RURectF (*map_rect)(struct RUBase* self_c, struct RUBase* arg0);
    void (*map)(struct RUBase* self_c, int x, int y, struct RUBase* tx, struct RUBase* ty);
    void (*map)(struct RUBase* self_c, float x, float y, struct RUBase* tx, struct RUBase* ty);
    struct RUMatrix (*to_affine)(struct RUBase* self_c);
    struct RUTransform (*from_translate)(struct RUBase* self_c, float dx, float dy);
