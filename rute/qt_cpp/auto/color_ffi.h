...
typedef struct RUColorFuncs {
    ...
    void (*get_rgb_f)(struct RUBase* self_c, struct RUBase* r, struct RUBase* g, struct RUBase* b, struct RUBase* a);
    void (*set_rgb_f)(struct RUBase* self_c, float r, float g, float b, float a);
    ...
    void (*get_hsv)(struct RUBase* self_c, struct RUBase* h, struct RUBase* s, struct RUBase* v, struct RUBase* a);
    void (*set_hsv)(struct RUBase* self_c, int h, int s, int v, int a);
    void (*get_hsv_f)(struct RUBase* self_c, struct RUBase* h, struct RUBase* s, struct RUBase* v, struct RUBase* a);
    void (*set_hsv_f)(struct RUBase* self_c, float h, float s, float v, float a);
    ...
    void (*get_cmyk)(struct RUBase* self_c, struct RUBase* c, struct RUBase* m, struct RUBase* y, struct RUBase* k, struct RUBase* a);
    void (*set_cmyk)(struct RUBase* self_c, int c, int m, int y, int k, int a);
    void (*get_cmyk_f)(struct RUBase* self_c, struct RUBase* c, struct RUBase* m, struct RUBase* y, struct RUBase* k, struct RUBase* a);
    void (*set_cmyk_f)(struct RUBase* self_c, float c, float m, float y, float k, float a);
    ...
    void (*get_hsl)(struct RUBase* self_c, struct RUBase* h, struct RUBase* s, struct RUBase* l, struct RUBase* a);
    void (*set_hsl)(struct RUBase* self_c, int h, int s, int l, int a);
    void (*get_hsl_f)(struct RUBase* self_c, struct RUBase* h, struct RUBase* s, struct RUBase* l, struct RUBase* a);
    void (*set_hsl_f)(struct RUBase* self_c, float h, float s, float l, float a);
    ...
    struct RUColor (*from_rgb)(struct RUBase* self_c, int r, int g, int b, int a);
    struct RUColor (*from_rgb_f)(struct RUBase* self_c, float r, float g, float b, float a);
    struct RUColor (*from_rgba64)(struct RUBase* self_c, uint16_t r, uint16_t g, uint16_t b, uint16_t a);
    struct RUColor (*from_hsv)(struct RUBase* self_c, int h, int s, int v, int a);
    struct RUColor (*from_hsv_f)(struct RUBase* self_c, float h, float s, float v, float a);
    struct RUColor (*from_cmyk)(struct RUBase* self_c, int c, int m, int y, int k, int a);
    struct RUColor (*from_cmyk_f)(struct RUBase* self_c, float c, float m, float y, float k, float a);
    struct RUColor (*from_hsl)(struct RUBase* self_c, int h, int s, int l, int a);
    struct RUColor (*from_hsl_f)(struct RUBase* self_c, float h, float s, float l, float a);
