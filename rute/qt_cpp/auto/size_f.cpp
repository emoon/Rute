...
static void size_f_scale(struct RUBase* self_c, struct RUBase* s, int mode) {
    WRSizeF* qt_value = (WRSizeF*)self_c;
...
static struct RUSizeF size_f_scaled(struct RUBase* self_c, struct RUBase* s, int mode) {
    WRSizeF* qt_value = (WRSizeF*)self_c;
