...
typedef struct RUApplicationFuncs {
    ...
    void (*set_about_to_quit_event)(void* object, void* user_data, void* wrapped_func, void (*event)(void* self_c));
    void (*set_screen_added_event)(void* object, void* user_data, void* wrapped_func, void (*event)(void* self_c, struct RUBase* screen));
