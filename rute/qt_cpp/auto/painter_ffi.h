...
typedef struct RUPainterFuncs {
    ...
    void (*set_brush_origin_3)(struct RUBase* self_c, struct RUBase* arg0);
    ...
    void (*set_transform)(struct RUBase* self_c, struct RUBase* transform,
                          bool combine);
    struct RUTransform (*device_transform)(struct RUBase* self_c);
    void (*reset_transform)(struct RUBase* self_c);
    void (*set_world_transform)(struct RUBase* self_c, struct RUBase* matrix,
                                bool combine);
    ...
    void (*set_window_2)(struct RUBase* self_c, int x, int y, int w, int h);
    struct RURect (*viewport)(struct RUBase* self_c);
    void (*set_viewport)(struct RUBase* self_c, struct RUBase* viewport);
    void (*set_viewport_2)(struct RUBase* self_c, int x, int y, int w, int h);
    ...
    void (*draw_point_2)(struct RUBase* self_c, struct RUBase* p);
    void (*draw_point_3)(struct RUBase* self_c, int x, int y);
    void (*draw_points)(struct RUBase* self_c, struct RUBase* points,
                        int point_count);
    void (*draw_points_2)(struct RUBase* self_c, struct RUBase* points);
    void (*draw_points_3)(struct RUBase* self_c, struct RUBase* points,
                          int point_count);
    void (*draw_points_4)(struct RUBase* self_c, struct RUBase* points);
    void (*draw_line)(struct RUBase* self_c, struct RUBase* line);
    void (*draw_line_2)(struct RUBase* self_c, struct RUBase* line);
    void (*draw_line_3)(struct RUBase* self_c, int x1, int y1, int x2, int y2);
    void (*draw_line_4)(struct RUBase* self_c, struct RUBase* p1,
                        struct RUBase* p2);
    void (*draw_line_5)(struct RUBase* self_c, struct RUBase* p1,
                        struct RUBase* p2);
    void (*draw_lines)(struct RUBase* self_c, struct RUBase* lines,
                       int line_count);
    void (*draw_lines_3)(struct RUBase* self_c, struct RUBase* point_pairs,
                         int line_count);
    void (*draw_lines_7)(struct RUBase* self_c, struct RUBase* point_pairs,
                         int line_count);
    void (*draw_rect)(struct RUBase* self_c, struct RUBase* rect);
    void (*draw_rect_2)(struct RUBase* self_c, int x1, int y1, int w, int h);
    void (*draw_rect_3)(struct RUBase* self_c, struct RUBase* rect);
    void (*draw_rects)(struct RUBase* self_c, struct RUBase* rects,
                       int rect_count);
    void (*draw_rects_3)(struct RUBase* self_c, struct RUBase* rects,
                         int rect_count);
    void (*draw_ellipse)(struct RUBase* self_c, struct RUBase* r);
    void (*draw_ellipse_2)(struct RUBase* self_c, struct RUBase* r);
    void (*draw_ellipse_3)(struct RUBase* self_c, int x, int y, int w, int h);
    void (*draw_ellipse_4)(struct RUBase* self_c, struct RUBase* center,
                           float rx, float ry);
    void (*draw_ellipse_5)(struct RUBase* self_c, struct RUBase* center, int rx,
                           int ry);
    void (*draw_polyline)(struct RUBase* self_c, struct RUBase* points,
                          int point_count);
    void (*draw_polyline_2)(struct RUBase* self_c, struct RUBase* polyline);
    void (*draw_polyline_3)(struct RUBase* self_c, struct RUBase* points,
                            int point_count);
    ...
    void (*draw_convex_polygon_2)(struct RUBase* self_c,
                                  struct RUBase* polygon);
    void (*draw_convex_polygon_3)(struct RUBase* self_c, struct RUBase* points,
                                  int point_count);
    void (*draw_convex_polygon_4)(struct RUBase* self_c,
                                  struct RUBase* polygon);
    void (*draw_arc)(struct RUBase* self_c, struct RUBase* rect, int a,
                     int alen);
    void (*draw_arc_2)(struct RUBase* self_c, struct RUBase* arg0, int a,
                       int alen);
    void (*draw_arc_3)(struct RUBase* self_c, int x, int y, int w, int h, int a,
                       int alen);
    void (*draw_pie)(struct RUBase* self_c, struct RUBase* rect, int a,
                     int alen);
    void (*draw_pie_2)(struct RUBase* self_c, int x, int y, int w, int h, int a,
                       int alen);
    void (*draw_pie_3)(struct RUBase* self_c, struct RUBase* arg0, int a,
                       int alen);
    void (*draw_chord)(struct RUBase* self_c, struct RUBase* rect, int a,
                       int alen);
    void (*draw_chord_2)(struct RUBase* self_c, int x, int y, int w, int h,
                         int a, int alen);
    ...
    void (*draw_round_rect_2)(struct RUBase* self_c, int x, int y, int w, int h,
                              int arg0, int arg1);
    void (*draw_round_rect_3)(struct RUBase* self_c, struct RUBase* r,
                              int xround, int yround);
    void (*draw_tiled_pixmap)(struct RUBase* self_c, struct RUBase* rect,
                              struct RUBase* pm, struct RUBase* offset);
    void (*draw_tiled_pixmap_2)(struct RUBase* self_c, int x, int y, int w,
                                int h, struct RUBase* arg0, int sx, int sy);
    void (*draw_tiled_pixmap_3)(struct RUBase* self_c, struct RUBase* arg0,
                                struct RUBase* arg1, struct RUBase* arg2);
    void (*draw_pixmap)(struct RUBase* self_c, struct RUBase* target_rect,
                        struct RUBase* pixmap, struct RUBase* source_rect);
    void (*draw_pixmap_2)(struct RUBase* self_c, struct RUBase* target_rect,
                          struct RUBase* pixmap, struct RUBase* source_rect);
    void (*draw_pixmap_3)(struct RUBase* self_c, int x, int y, int w, int h,
                          struct RUBase* pm, int sx, int sy, int sw, int sh);
    void (*draw_pixmap_4)(struct RUBase* self_c, int x, int y,
                          struct RUBase* pm, int sx, int sy, int sw, int sh);
    void (*draw_pixmap_5)(struct RUBase* self_c, struct RUBase* p,
                          struct RUBase* pm, struct RUBase* sr);
    void (*draw_pixmap_6)(struct RUBase* self_c, struct RUBase* p,
                          struct RUBase* pm, struct RUBase* sr);
    void (*draw_pixmap_7)(struct RUBase* self_c, struct RUBase* p,
                          struct RUBase* pm);
    void (*draw_pixmap_8)(struct RUBase* self_c, struct RUBase* p,
                          struct RUBase* pm);
    void (*draw_pixmap_9)(struct RUBase* self_c, int x, int y,
                          struct RUBase* pm);
    void (*draw_pixmap_10)(struct RUBase* self_c, struct RUBase* r,
                           struct RUBase* pm);
    void (*draw_pixmap_11)(struct RUBase* self_c, int x, int y, int w, int h,
                           struct RUBase* pm);
    ...
    void (*draw_image_6)(struct RUBase* self_c, struct RUBase* r,
                         struct RUBase* image);
    void (*draw_image_7)(struct RUBase* self_c, struct RUBase* p,
                         struct RUBase* image);
    void (*draw_image_8)(struct RUBase* self_c, struct RUBase* p,
                         struct RUBase* image);
    ...
    void (*draw_text_4)(struct RUBase* self_c, struct RUBase* p,
                        const char* str, int tf, int justification_padding);
    void (*draw_text_5)(struct RUBase* self_c, struct RUBase* r, int flags,
                        const char* text, struct RUBase* br);
    void (*draw_text_6)(struct RUBase* self_c, struct RUBase* r, int flags,
                        const char* text, struct RUBase* br);
    void (*draw_text_7)(struct RUBase* self_c, int x, int y, int w, int h,
                        int flags, const char* text, struct RUBase* br);
    struct RURectF (*bounding_rect)(struct RUBase* self_c, struct RUBase* rect,
                                    int flags, const char* text);
    struct RURect (*bounding_rect_2)(struct RUBase* self_c, struct RUBase* rect,
                                     int flags, const char* text);
    struct RURect (*bounding_rect_3)(struct RUBase* self_c, int x, int y, int w,
                                     int h, int flags, const char* text);
    void (*fill_rect)(struct RUBase* self_c, struct RUBase* arg0,
                      struct RUBase* arg1);
    void (*fill_rect_2)(struct RUBase* self_c, int x, int y, int w, int h,
                        struct RUBase* arg0);
    void (*fill_rect_3)(struct RUBase* self_c, struct RUBase* arg0,
                        struct RUBase* arg1);
    void (*fill_rect_4)(struct RUBase* self_c, struct RUBase* arg0,
                        struct RUBase* color);
    void (*fill_rect_5)(struct RUBase* self_c, int x, int y, int w, int h,
                        struct RUBase* color);
    ...
    struct RUPaintDevice (*redirected)(struct RUBase* self_c,
                                       struct RUBase* device,
                                       struct RUBase* offset);
