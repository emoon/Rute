...
typedef struct RUImageFuncs {
    ...
    struct RUImage (*copy_by_rect)(struct RUBase* self_c, struct RUBase* rect);
    ...
    bool (*valid_by_point)(struct RUBase* self_c, struct RUBase* pt);
    int (*pixel_index)(struct RUBase* self_c, int x, int y);
    int (*pixel_index_by_point)(struct RUBase* self_c, struct RUBase* pt);
    uint32_t (*pixel)(struct RUBase* self_c, int x, int y);
    uint32_t (*pixel_by_point)(struct RUBase* self_c, struct RUBase* pt);
    void (*set_pixel)(struct RUBase* self_c, int x, int y, struct RUuint index_or_rgb);
    void (*set_pixel_by_point)(struct RUBase* self_c, struct RUBase* pt, struct RUuint index_or_rgb);
    struct RUColor (*pixel_color)(struct RUBase* self_c, int x, int y);
    struct RUColor (*pixel_color_by_point)(struct RUBase* self_c, struct RUBase* pt);
    void (*set_pixel_color)(struct RUBase* self_c, int x, int y, struct RUBase* c);
    void (*set_pixel_color_by_point)(struct RUBase* self_c, struct RUBase* pt, struct RUBase* c);
    ...
    void (*fill_by_type)(struct RUBase* self_c, struct RUBase* color);
    void (*fill_by_color)(struct RUBase* self_c, int color);
    ...
    struct RUImage (*scaled_by_size)(struct RUBase* self_c, struct RUBase* s, int aspect_mode, int mode);
    ...
    bool (*load_by_io_device)(struct RUBase* self_c, struct RUBase* device, struct RUBase* format);
