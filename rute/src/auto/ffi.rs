...
pub struct RuteFFI {
    ...
    pub create_action: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUAction,
    pub create_widget: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUWidget,
    pub create_list_widget_item: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUListWidgetItem,
    pub create_list_widget: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUListWidget,
    pub create_timer: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUTimer,
    pub create_icon: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUIcon,
    pub create_menu: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUMenu,
    pub create_menu_bar: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUMenuBar,
    pub create_label: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RULabel,
    pub create_line_edit: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RULineEdit,
    pub create_plain_text_edit: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUPlainTextEdit,
    pub create_slider: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUSlider,
    pub create_main_window: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUMainWindow,
    pub create_v_box_layout: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUVBoxLayout,
    pub create_h_box_layout: extern "C" fn(priv_data: *const RUBase, user_data: *const c_void) -> *const RUHBoxLayout,
    pub privd: *const RUBase,
}
