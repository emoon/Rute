...
pub(crate) unsafe extern "C" fn push_button_pressed_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
) {
...
pub(crate) unsafe extern "C" fn push_button_pressed_trampoline(
    self_c: *const c_void,
    func: *const c_void,
) {
...
pub(crate) unsafe extern "C" fn push_button_released_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
) {
    let f: &&(Fn(&T) + 'static) = transmute(func);
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn push_button_released_trampoline(
    self_c: *const c_void,
    func: *const c_void,
) {
    let f: &&(Fn() + 'static) = transmute(func);
...
pub(crate) unsafe extern "C" fn push_button_clicked_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    checked: bool,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn push_button_clicked_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    checked: bool,
) {
...
pub(crate) unsafe extern "C" fn push_button_toggled_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    checked: bool,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn push_button_toggled_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    checked: bool,
) {
...
impl<'a> PushButton<'a> {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_rc(ffi_data: RUPushButton) -> PushButton<'a> {
        PushButton {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_owned(ffi_data: RUPushButton) -> PushButton<'a> {
        PushButton {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_temporary(ffi_data: RUPushButton) -> PushButton<'a> {
        PushButton {
            data: Rc::new(Cell::new(Some(ffi_data.qt_data as *const RUBase))),
            all_funcs: ffi_data.all_funcs,
            owned: false,
    ...
    pub fn set_auto_default(&self, arg0: bool) -> &Self {
        let (obj_data, funcs) = self.get_push_button_obj_funcs();
        unsafe {
    ...
    pub fn set_default(&self, arg0: bool) -> &Self {
        let (obj_data, funcs) = self.get_push_button_obj_funcs();
        unsafe {
    ...
    pub fn set_flat(&self, arg0: bool) -> &Self {
        let (obj_data, funcs) = self.get_push_button_obj_funcs();
        unsafe {
