...
pub trait TransformType<'a> {
    ...
    /// the generic case.
    fn type(&self) -> TransformationType {

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).type)(obj_data);
    ...
    fn inverted(&self, invertible: &bool) -> Transform {

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).inverted)(obj_data, invertible);
            let t = ret_val;
            let ret_val;
    ...
    fn map<P: PointType<'a>>(&self, p: &P) -> Point {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<P: PointFType<'a>>(&self, p: &P) -> PointF {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<L: LineType<'a>>(&self, l: &L) -> Line {
        let (obj_l_1, _funcs) = l.get_line_obj_funcs();

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).map)(obj_data, obj_l_1);
            let t = ret_val;
            let ret_val;
            if t.host_data != ::std::ptr::null() {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<L: LineFType<'a>>(&self, l: &L) -> LineF {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<P: PolygonFType<'a>>(&self, a: &P) -> PolygonF {
        let (obj_a_1, _funcs) = a.get_polygon_f_obj_funcs();

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).map)(obj_data, obj_a_1);
            let t = ret_val;
            let ret_val;
            if t.host_data != ::std::ptr::null() {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<P: PolygonType<'a>>(&self, a: &P) -> Polygon {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<R: RegionType<'a>>(&self, r: &R) -> Region {
        let (obj_r_1, _funcs) = r.get_region_obj_funcs();

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).map)(obj_data, obj_r_1);
            let t = ret_val;
            let ret_val;
            if t.host_data != ::std::ptr::null() {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map<P: PainterPathType<'a>>(&self, p: &P) -> PainterPath {
    ...
    /// {QTransform#Basic Matrix Operations}{Basic Matrix
    /// Operations}
    fn map_to_polygon<R: RectType<'a>>(&self, r: &R) -> Polygon {
    ...
    /// matrix. Note that the transformed coordinates are rounded to the
    /// nearest integer.
    fn map_rect<R: RectType<'a>>(&self, arg0: &R) -> Rect {
    ...
    /// matrix. Note that the transformed coordinates are rounded to the
    /// nearest integer.
    fn map_rect<R: RectFType<'a>>(&self, arg0: &R) -> RectF {
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map(&self, x: i32, y: i32, tx: &i32, ty: &i32) -> &Self {

        let (obj_data, funcs) = self.get_transform_obj_funcs();
        unsafe {
            ((*funcs).map)(obj_data, x, y, tx, ty);
        }
        self
    }
    /// 
    ...
    /// system defined by this matrix. The resulting values are put in * *tx* and * *ty,* respectively. Note that the transformed coordinates
    /// are rounded to the nearest integer.
    fn map(&self, x: f32, y: f32, tx: &f32, ty: &f32) -> &Self {
...
impl<'a> TransformType<'a> for Transform<'a> {
    #[inline]
    fn get_transform_obj_funcs(&self) -> (*const RUBase, *const RUTransformFuncs) {
        let obj = self.data.get().unwrap();
        unsafe {
            (obj, (*self.all_funcs).transform_funcs)
        }
    }
}
pub trait TransformStaticType {
    /// 
    ...
    /// 
    /// **See also:** quadToSquare()
    /// quadToQuad()
    fn square_to_quad<'a, P: PolygonFType<'a>, T: TransformType<'a>>(square: &P, result: &T) -> bool {
    ...
    /// 
    /// **See also:** squareToQuad()
    /// quadToQuad()
    fn quad_to_square<'a, P: PolygonFType<'a>, T: TransformType<'a>>(quad: &P, result: &T) -> bool {
    ...
    /// **See also:** squareToQuad()
    /// quadToSquare()
    fn quad_to_quad<'a, P: PolygonFType<'a>, T: TransformType<'a>>(one: &P, two: &P, result: &T) -> bool {
...
impl<'a> TransformStaticType for Transform<'a> {}

impl<'a> TransformStaticType for TransformStatic<'a> {}
