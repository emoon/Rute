...
impl<'a> DesktopWidget<'a> {
    #[allow(dead_code)]
    pub(crate) fn new_from_rc(ffi_data: RUDesktopWidget) -> DesktopWidget<'a> {
        DesktopWidget {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_owned(ffi_data: RUDesktopWidget) -> DesktopWidget<'a> {
        DesktopWidget {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_temporary(ffi_data: RUDesktopWidget) -> DesktopWidget<'a> {
        DesktopWidget {
            data: Rc::new(Cell::new(Some(ffi_data.qt_data as *const RUBase))),
            all_funcs: ffi_data.all_funcs,
            owned: false,
    ...
    pub fn screen_number<W: WidgetTrait<'a>>(&self, widget: &W) -> i32 {
        ...
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).screen_number)(obj_data, obj_widget_1);
            ret_val
        }
    }
    pub fn is_virtual_desktop(&self) -> bool {
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).is_virtual_desktop)(obj_data);
            ret_val
        }
    }
    pub fn num_screens(&self) -> i32 {
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).num_screens)(obj_data);
            ret_val
        }
    }
    pub fn screen_count(&self) -> i32 {
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).screen_count)(obj_data);
            ret_val
        }
    }
    ...
    pub fn screen_number_2<P: PointTrait<'a>>(&self, arg0: &P) -> i32 {
        ...
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).screen_number_2)(obj_data, obj_arg0_1);
            ret_val
        }
    }
    pub fn screen(&self, screen: i32) -> Option<Widget> {
        let (obj_data, funcs) = self.get_desktop_widget_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).screen)(obj_data, screen);
...
impl<'a> From<WrapperRcOwn> for DesktopWidget<'a> {
    fn from(t: WrapperRcOwn) -> Self {
        let mut data = RUDesktopWidget {
            qt_data: ::std::ptr::null(),
            host_data: ::std::ptr::null(),
            all_funcs: t.all_funcs as *const RUDesktopWidgetAllFuncs,
        };

        if t.owned {
            data.host_data = t.data as *const RUBase;
            DesktopWidget::new_from_rc(data)
        } else {
            data.qt_data = t.data as *const RUBase;
            DesktopWidget::new_from_temporary(data)
        }
    }
}
...
pub trait DesktopWidgetTrait<'a> {
    #[inline]
    #[doc(hidden)]
    fn get_desktop_widget_obj_funcs(&self) -> (*const RUBase, *const RUDesktopWidgetFuncs);
}
...
impl<'a> DesktopWidgetTrait<'a> for DesktopWidget<'a> {
    #[doc(hidden)]
    fn get_desktop_widget_obj_funcs(&self) -> (*const RUBase, *const RUDesktopWidgetFuncs) {
        let obj = self.data.get().unwrap();
        unsafe { (obj, (*self.all_funcs).desktop_widget_funcs) }
    }
}
