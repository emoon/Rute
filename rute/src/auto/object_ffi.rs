...
pub struct RUObjectFuncs {
    ...
    pub start_timer: extern "C" fn(self_c: *const RUBase, interval: i32, timer_type: i32) -> i32,
    pub start_timer_2: extern "C" fn(self_c: *const RUBase, time: u32, timer_type: i32) -> i32,
