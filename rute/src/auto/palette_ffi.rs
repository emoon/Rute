...
pub struct RUPaletteFuncs {
    ...
    pub current_color_group: extern "C" fn(self_c: *const RUBase) -> i32,
    pub set_current_color_group: extern "C" fn(self_c: *const RUBase, cg: i32),
    pub color: extern "C" fn(self_c: *const RUBase, cg: i32, cr: i32) -> RUColor,
    pub brush: extern "C" fn(self_c: *const RUBase, cg: i32, cr: i32) -> RUBrush,
    pub set_color: extern "C" fn(self_c: *const RUBase, cg: i32, cr: i32, color: *const RUBase),
    pub set_color_2: extern "C" fn(self_c: *const RUBase, cr: i32, color: *const RUBase),
    pub set_brush: extern "C" fn(self_c: *const RUBase, cr: i32, brush: *const RUBase),
    pub is_brush_set: extern "C" fn(self_c: *const RUBase, cg: i32, cr: i32) -> bool,
    pub set_brush_2: extern "C" fn(self_c: *const RUBase, cg: i32, cr: i32, brush: *const RUBase),
    ...
    pub is_equal: extern "C" fn(self_c: *const RUBase, cr1: i32, cr2: i32) -> bool,
    pub color_2: extern "C" fn(self_c: *const RUBase, cr: i32) -> RUColor,
    pub brush_2: extern "C" fn(self_c: *const RUBase, cr: i32) -> RUBrush,
