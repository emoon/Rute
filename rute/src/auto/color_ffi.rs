...
pub struct RUColorFuncs {
    ...
    pub name_2: extern "C" fn(self_c: *const RUBase, format: u32) -> *const ::std::os::raw::c_char,
    pub set_named_color: extern "C" fn(self_c: *const RUBase, name: *const ::std::os::raw::c_char),
    pub spec: extern "C" fn(self_c: *const RUBase) -> u32,
    ...
    pub convert_to: extern "C" fn(self_c: *const RUBase, color_spec: u32) -> RUColor,
