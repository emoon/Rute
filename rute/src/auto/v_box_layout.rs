...
///
/// ![Horizontal box layout with five child widgets](qvboxlayout-with-5-children.png)
///
/// **See also:** [`HBoxLayout`]
/// [`GridLayout`]
/// [`StackedLayout`]
...
impl<'a> VBoxLayout<'a> {
    pub fn new() -> VBoxLayout<'a> {
        let data = Rc::new(Cell::new(None));

        let ffi_data = unsafe {
            ((*rute_ffi_get()).create_v_box_layout)(
                ::std::ptr::null(),
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_rc(ffi_data: RUVBoxLayout) -> VBoxLayout<'a> {
        VBoxLayout {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_owned(ffi_data: RUVBoxLayout) -> VBoxLayout<'a> {
        VBoxLayout {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_temporary(ffi_data: RUVBoxLayout) -> VBoxLayout<'a> {
        VBoxLayout {
            data: Rc::new(Cell::new(Some(ffi_data.qt_data as *const RUBase))),
            all_funcs: ffi_data.all_funcs,
            owned: false,
...
impl<'a> From<WrapperRcOwn> for VBoxLayout<'a> {
    fn from(t: WrapperRcOwn) -> Self {
        let mut data = RUVBoxLayout {
            qt_data: ::std::ptr::null(),
            host_data: ::std::ptr::null(),
            all_funcs: t.all_funcs as *const RUVBoxLayoutAllFuncs,
        };

        if t.owned {
            data.host_data = t.data as *const RUBase;
            VBoxLayout::new_from_rc(data)
        } else {
            data.qt_data = t.data as *const RUBase;
            VBoxLayout::new_from_temporary(data)
        }
    }
}

pub trait VBoxLayoutTrait<'a> {
    #[inline]
    #[doc(hidden)]
    fn get_v_box_layout_obj_funcs(&self) -> (*const RUBase, *const RUVBoxLayoutFuncs);
}

impl<'a> ObjectTrait<'a> for VBoxLayout<'a> {
    #[doc(hidden)]
...
impl<'a> LayoutItemTrait<'a> for VBoxLayout<'a> {
    #[doc(hidden)]
...
impl<'a> LayoutTrait<'a> for VBoxLayout<'a> {
    #[doc(hidden)]
...
impl<'a> BoxLayoutTrait<'a> for VBoxLayout<'a> {
    #[doc(hidden)]
...
impl<'a> VBoxLayoutTrait<'a> for VBoxLayout<'a> {
    #[doc(hidden)]
    fn get_v_box_layout_obj_funcs(&self) -> (*const RUBase, *const RUVBoxLayoutFuncs) {
        let obj = self.data.get().unwrap();
        unsafe { (obj, (*self.all_funcs).v_box_layout_funcs) }
    }
}
