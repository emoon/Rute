...
use rute::auto::list_widget_ffi::RUListWidget;
use rute::auto::size_ffi::RUSize;
...
pub struct RUListWidgetItemFuncs {
    ...
    pub check_state: extern "C" fn(self_c: *const RUBase) -> i32,
    pub set_check_state: extern "C" fn(self_c: *const RUBase, state: i32),
