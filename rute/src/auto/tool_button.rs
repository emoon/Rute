...
pub(crate) unsafe extern "C" fn tool_button_mouse_press_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_mouse_press_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_mouse_release_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn tool_button_mouse_release_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_paint_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn tool_button_paint_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_enter_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn tool_button_enter_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_leave_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn tool_button_leave_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
pub(crate) unsafe extern "C" fn tool_button_change_trampoline_ud<T>(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
#[allow(unused_variables)]
pub(crate) unsafe extern "C" fn tool_button_change_trampoline(
    self_c: *const c_void,
    func: *const c_void,
    arg0: *const RUBase,
) {
...
impl<'a> ToolButton<'a> {
    pub fn new() -> ToolButton<'a> {
        let data = Rc::new(Cell::new(None));

        let ffi_data = unsafe {
            ((*rute_ffi_get()).create_tool_button)(
                ::std::ptr::null(),
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_owned(ffi_data: RUToolButton) -> ToolButton<'a> {
        ToolButton {
    ...
    #[allow(dead_code)]
    pub(crate) fn new_from_temporary(ffi_data: RUToolButton) -> ToolButton<'a> {
        ToolButton {
            data: Rc::new(Cell::new(Some(ffi_data.qt_data as *const RUBase))),
            all_funcs: ffi_data.all_funcs,
            owned: false,
    ...
    pub fn set_arrow_type(&self, arrow_type: ArrowType) -> &Self {
        ...
        let (obj_data, funcs) = self.get_tool_button_obj_funcs();
        unsafe {
            ((*funcs).set_arrow_type)(obj_data, enum_arrow_type_1);
        }
        self
    }
    pub fn set_popup_mode(&self, mode: ToolButtonPopupMode) -> &Self {
        ...
        let (obj_data, funcs) = self.get_tool_button_obj_funcs();
        unsafe {
            ((*funcs).set_popup_mode)(obj_data, enum_mode_1);
        }
        self
    }
    ///
    ...
    pub fn auto_raise(&self) -> bool {
        let (obj_data, funcs) = self.get_tool_button_obj_funcs();
        unsafe {
            let ret_val = ((*funcs).auto_raise)(obj_data);
            ret_val
        }
    }
    ///
    ...
    pub fn set_tool_button_style(&self, style: ToolButtonStyle) -> &Self {
        ...
        let (obj_data, funcs) = self.get_tool_button_obj_funcs();
        unsafe {
            ((*funcs).set_tool_button_style)(obj_data, enum_style_1);
        }
        self
    }
    ///
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_mouse_press_event)(
                ...
                transmute(tool_button_mouse_press_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&MouseEvent) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_mouse_press_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_mouse_press_trampoline as usize),
            );
        }
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_mouse_release_event)(
                ...
                user_data,
                Box::into_raw(f) as *const _,
                transmute(tool_button_mouse_release_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&MouseEvent) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_mouse_release_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_mouse_release_trampoline as usize),
            );
        }
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_paint_event)(
                ...
                user_data,
                Box::into_raw(f) as *const _,
                transmute(tool_button_paint_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&PaintEvent) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_paint_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_paint_trampoline as usize),
            );
        }
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_enter_event)(
                ...
                user_data,
                Box::into_raw(f) as *const _,
                transmute(tool_button_enter_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&Event) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_enter_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_enter_trampoline as usize),
            );
        }
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_leave_event)(
                ...
                user_data,
                Box::into_raw(f) as *const _,
                transmute(tool_button_leave_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&Event) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_leave_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_leave_trampoline as usize),
            );
        }
        ...
        T: 'a,
    {
        ...
        unsafe {
            ((*funcs).set_change_event)(
                ...
                user_data,
                Box::into_raw(f) as *const _,
                transmute(tool_button_change_trampoline_ud::<T> as usize),
            );
        }
        ...
        F: Fn(&Event) + 'a,
    {
        ...
        unsafe {
            ((*funcs).set_change_event)(
                ...
                ::std::ptr::null(),
                Box::into_raw(f) as *const _,
                transmute(tool_button_change_trampoline as usize),
            );
        }
...
pub trait ToolButtonTrait<'a> {
    #[inline]
    #[doc(hidden)]
    fn get_tool_button_obj_funcs(&self) -> (*const RUBase, *const RUToolButtonFuncs);
}

impl<'a> ObjectTrait<'a> for ToolButton<'a> {
    #[doc(hidden)]
...
impl<'a> PaintDeviceTrait<'a> for ToolButton<'a> {
    #[doc(hidden)]
...
impl<'a> WidgetTrait<'a> for ToolButton<'a> {
    #[doc(hidden)]
...
impl<'a> AbstractButtonTrait<'a> for ToolButton<'a> {
    #[doc(hidden)]
...
impl<'a> ToolButtonTrait<'a> for ToolButton<'a> {
    #[doc(hidden)]
    fn get_tool_button_obj_funcs(&self) -> (*const RUBase, *const RUToolButtonFuncs) {
        let obj = self.data.get().unwrap();
        unsafe { (obj, (*self.all_funcs).tool_button_funcs) }
    }
}
#[repr(u32)]
